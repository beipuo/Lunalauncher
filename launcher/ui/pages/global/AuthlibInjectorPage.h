...
namespace Ui {
class AuthlibInjectorPage;
}

class AuthlibInjectorPage : public QWidget, public BasePage {
    Q_OBJECT

   public:
    explicit AuthlibInjectorPage(QWidget* parent = 0);
    ~AuthlibInjectorPage();
   ...
   private:
    void updateStatus();
    void updateDownloadSource();

   private:
    Ui::AuthlibInjectorPage* ui;
};
